...
public class BLBlockRegistry {
	...
	public static final Block stalactite = new BlockStalactite(Material.rock).setHardness(0.75F).setStepSound(Block.soundTypeStone).setBlockName("thebetweenlands.stalactite").setCreativeTab(BLCreativeTabs.blocks);
	...
	public static final Block betweenstoneBricks = new BlockBLGenericDeco("betweenstoneBricks", Material.rock).setHardness(1.5F).setResistance(2000.0F).setStepSound(Block.soundTypeStone);
	public static final Block betweenstoneBricksCracked = new BlockBLGenericDeco("betweenstoneBricksCracked", Material.rock).setHardness(1.5F).setResistance(2000.0F).setStepSound(Block.soundTypeStone);
	public static final Block betweenstoneTiles = new BlockBLGenericDeco("betweenstoneTiles", Material.rock).setHardness(1.5F).setResistance(2000.0F).setStepSound(Block.soundTypeStone);
	public static final Block betweenstoneBricksMossy = new BlockBLGenericDeco("betweenstoneBricksMossy", Material.rock).setHardness(1.5F).setResistance(2000.0F).setStepSound(Block.soundTypeStone);
	public static final Block betweenstoneTilesMossy = new BlockBLGenericDeco("betweenstoneTilesMossy", Material.rock).setHardness(1.5F).setResistance(2000.0F).setStepSound(Block.soundTypeStone);
	public static final Block betweenstoneTilesCracked = new BlockBLGenericDeco("betweenstoneTilesCracked", Material.rock).setHardness(1.5F).setResistance(2000.0F).setStepSound(Block.soundTypeStone);
	public static final Block betweenstoneTilesCollapsing = new BlockBLCollapsing("betweenstoneTilesCollapsing", Material.rock, false).setHardness(1.5F).setResistance(2000.0F).setStepSound(Block.soundTypeStone);
	public static final Block betweenstoneTilesMossyCollapsing = new BlockBLCollapsing("betweenstoneTilesMossyCollapsing", Material.rock, false).setHardness(1.5F).setResistance(2000.0F).setStepSound(Block.soundTypeStone);
	public static final Block betweenstoneSmoothMossy = new BlockBLGenericDeco("betweenstoneSmoothMossy", Material.rock).setHardness(1.5F).setResistance(2000.0F).setStepSound(Block.soundTypeStone);
	public static final Block chiseledBetweenstone = new BlockBLGenericDeco("chiseledBetweenstone", Material.rock).setHardness(1.5F).setResistance(2000.0F).setStepSound(Block.soundTypeStone);
	public static final Block betweenstoneBricksMirage = new BlockBetweenstoneBricksMirage(Material.circuits).setHardness(1.5F).setResistance(2000.0F).setStepSound(Block.soundTypeStone);
	...
	public static final Block polishedLimestone = new BlockBLGenericDeco("polishedLimestone", Material.rock).setHardness(1.5F).setResistance(2000.0F).setStepSound(Block.soundTypeStone);
	public static final Block limestoneBricks = new BlockBLGenericDeco("limestoneBricks", Material.rock).setHardness(1.5F).setResistance(2000.0F).setStepSound(Block.soundTypeStone);
	public static final Block limestoneTiles = new BlockBLGenericDeco("limestoneTiles", Material.rock).setHardness(1.5F).setResistance(2000.0F).setStepSound(Block.soundTypeStone);
	public static final Block polishedLimestoneCollapsing = new BlockBLCollapsing("polishedLimestoneCollapsing", Material.rock, false).setHardness(1.5F).setResistance(2000.0F).setStepSound(Block.soundTypeStone);
	public static final Block chiseledLimestone = new BlockBLGenericDeco("chiseledLimestone", Material.rock).setHardness(1.5F).setResistance(2000.0F).setStepSound(Block.soundTypeStone);
	...
	public static final Block smoothBetweenstone = new BlockBLGenericDeco("smoothBetweenstone", Material.rock).setHardness(1.5F).setResistance(2000.0F).setStepSound(Block.soundTypeStone);
	...
	public static final Block betweenstoneBrickStairsMossy = new BlockBLStairs(betweenstoneBricksMossy, 0).setBlockName("thebetweenlands.betweenstoneBrickStairsMossy");
	public static final Block betweenstoneSmoothStairsMossy = new BlockBLStairs(betweenstoneSmoothMossy, 0).setBlockName("thebetweenlands.betweenstoneSmoothStairsMossy");
